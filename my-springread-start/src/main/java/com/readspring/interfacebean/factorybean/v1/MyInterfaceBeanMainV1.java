 ...
 */
@Configuration
@MapperScan(value = {"com.readspring.interfacebean"}, basePackages = {})
@Import(MapperProxyRegister.class)
public class MyInterfaceBeanMainV1 {

	public static void main(String[] args) {
//		new MyInterfaceBeanMain().testGeneric1();
		AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(MyInterfaceBeanMainV1.class);
